...
export default function AboutMe() {
  return (
    <div className="[&_p]:mb-4 md:[&_p]:text-right [&_p]:text-left [&_p]:font-medium
    [&_p>strong]:text-yellow-300 [&_p>em]:text-cyan-400"
    >
      <Image
        className="rounded-full size-60 m-auto md:float-left md:ml-3"
        width="200"
        height="200"
